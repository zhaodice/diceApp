...
import terminal.noconsole.SystemOutputPrintStream
...
object MiraiConsoleTerminalLoader {
    ...
    fun startAsDaemon(instance: MiraiConsoleImplementationTerminal = MiraiConsoleImplementationTerminal()):MiraiConsoleImplementationTerminal {
        instance.start()
        overrideSTD()
